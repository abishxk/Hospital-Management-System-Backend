...
public class AppointmentController {
    ...
    @GetMapping("/find")
    public List<Appointment> findAppointmentsByAppointmentsType(@RequestParam AppointmentType type){
        return appointmentService.findAppointmentsByAppointmentsType(type);
